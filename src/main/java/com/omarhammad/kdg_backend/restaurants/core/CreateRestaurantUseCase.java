...
public class CreateRestaurantUseCase implements ICreateRestaurantUseCase {
    ...
    private final LoadRestaurantData loadRestaurantData;
    private final LoadOwnerData loadOwnerData;


    public CreateRestaurantUseCase(LoadRestaurantData loadRestaurantData, LoadOwnerData loadOwnerData) {
        this.loadRestaurantData = loadRestaurantData;
    ...
    public void CreateRestaurant(CreateRestaurantCmd cmd) {
        ...
        loadRestaurantData.saveRestaurant(restaurant);
